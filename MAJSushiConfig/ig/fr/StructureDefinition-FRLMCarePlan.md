...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fr.metier.document.core|current/StructureDefinition/FRLMCarePlan)
...
Autres représentations du profil : [CSV](../StructureDefinition-FRLMCarePlan.csv), [Excel](../StructureDefinition-FRLMCarePlan.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/metier/document-core/StructureDefinition/FRLMCarePlan",
  "version" : "0.1.0",
  "name" : "FRLMCarePlan",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://interop.esante.gouv.fr/ig/metier/document-core/StructureDefinition/FRLMCarePlan",
