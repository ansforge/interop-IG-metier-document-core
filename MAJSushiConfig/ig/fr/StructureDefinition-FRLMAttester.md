...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fr.metier.document.core|current/StructureDefinition/FRLMAttester)
...
Autres représentations du profil : [CSV](../StructureDefinition-FRLMAttester.csv), [Excel](../StructureDefinition-FRLMAttester.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/metier/document-core/StructureDefinition/FRLMAttester",
  "version" : "0.1.0",
  "name" : "FRLMAttester",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://interop.esante.gouv.fr/ig/metier/document-core/StructureDefinition/FRLMAttester",
