...
* Utilise ce/t/te Modèle logique: [Logical model - FR LM Course of encounter](StructureDefinition-FRLMCourseOfEncounter.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fr.metier.document.core|current/StructureDefinition/FRLMPatientTransfer)
...
Autres représentations du profil : [CSV](../StructureDefinition-FRLMPatientTransfer.csv), [Excel](../StructureDefinition-FRLMPatientTransfer.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/metier/document-core/StructureDefinition/FRLMPatientTransfer",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://interop.esante.gouv.fr/ig/metier/document-core/StructureDefinition/FRLMPatientTransfer",
