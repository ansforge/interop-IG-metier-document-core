...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fr.metier.document.core|current/StructureDefinition/StructureDefinition-FRLMEncounter.json)
...
Other representations of profile: [CSV](../StructureDefinition-FRLMEncounter.csv), [Excel](../StructureDefinition-FRLMEncounter.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/metier/document-core/StructureDefinition/FRLMEncounter",
  "version" : "0.1.0",
  "name" : "FRLMEncounter",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://interop.esante.gouv.fr/ig/metier/document-core/StructureDefinition/FRLMEncounter",
