...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fr.metier.document.core|current/StructureDefinition/StructureDefinition-FRLMCourseOfEncounter.json)
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/metier/document-core/StructureDefinition/FRLMCourseOfEncounter",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://interop.esante.gouv.fr/ig/metier/document-core/StructureDefinition/FRLMCourseOfEncounter",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "*",
      "type" : [{
        "code" : "https://interop.esante.gouv.fr/ig/metier/document-core/StructureDefinition/FRLMPatientTransfer"
      }]
    },
    {
