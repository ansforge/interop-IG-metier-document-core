...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.id
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.statusCode
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.entryRelationship:frReferenceItemPrescription
* group[=].element[=].target.equivalence = #equivalent
// Médicament délivré
* group[=].element[+].code = #FRLMMedicationDispense.medicament
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.product:frProduitDeSante
* group[=].element[=].target.equivalence = #equivalent
// Quantité de produit
* group[=].element[+].code = #FRLMMedicationDispense.dispensedQuantity
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.quantity
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.entryRelationship:frActeSubstitution
* group[=].element[=].target.equivalence = #equivalent
// Posologie (regroupe 'traitement' et 'instructionsPatient')
// 'traitement' 
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.entryRelationship:frTraitement
* group[=].element[=].target.equivalence = #equivalent
// Posologie sous forme textuelle
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.renderedDosageInstruction
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.entryRelationship:frTraitement.text
* group[=].element[=].target.equivalence = #equivalent
// sequence
...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.entryRelationship:frInstructionsAuPatient
* group[=].element[=].target.equivalence = #equivalent
// Dose administrée par prise
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.doseAndRate.dose[x]
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.entryRelationship:frTraitement.doseQuantity
* group[=].element[=].target.equivalence = #equivalent
// Rythme d'administration
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.doseAndRate.rate[x]
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.entryRelationship:frTraitement.rateQuantity
* group[=].element[=].target.equivalence = #equivalent
// Fréquence de prise
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.frequency
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.entryRelationship:frTraitement.effectiveTime
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.entryRelationship:frTraitement.effectiveTime.frequency
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.entryRelationship:frTraitement.effectiveTime.period
* group[=].element[=].target.equivalence = #equivalent
// Jour de la semaine
...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.effectiveTime
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.precondition
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.approachSiteCode
* group[=].element[=].target.equivalence = #equivalent
// Voie d'administration
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.routeOfAdministration
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.routeCode
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.maxDoseQuantity
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRCDATraitementDispense.entryRelationship:frTraitement.entryRelationship:frNotesDuDispensateur
* group[=].element[=].target.equivalence = #equivalent
...
// Auteur de la dispensation
* group[=].element[+].code = #FRLMMedicationDispense.header.author[x]
* group[=].element[=].target.code = #FRMedicationDispenseDocument.performer.actor
* group[=].element[=].target.equivalence = #equivalent
// Statut de la ligne de dispensation
* group[=].element[+].code = #FRLMMedicationDispense.header.status
...
// Destinataire de la dispensation
* group[=].element[+].code = #FRLMMedicationDispense.receiver[x]
* group[=].element[=].target.code = #FRMedicationDispenseDocument.receiver
* group[=].element[=].target.equivalence = #equivalent
// Référence de la prescription
* group[=].element[+].code = #FRLMMedicationDispense.relatedRequest
...
// Date et heure de dispense
* group[=].element[+].code = #FRLMMedicationDispense.timeOfDispensation
* group[=].element[=].target.code = #FRMedicationDispenseDocument.whenHandedOver
* group[=].element[=].target.equivalence = #equivalent
// Autorisation de substitution
* group[=].element[+].code = #FRLMMedicationDispense.substitutionOccurred
* group[=].element[=].target.code = #FRMedicationDispenseDocument.substitution.wasSubstituted
* group[=].element[=].target.equivalence = #equivalent
...
// Posologie
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction
* group[=].element[=].target.equivalence = #equivalent
// Posologie sous forme textuelle
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.renderedDosageInstruction
...
// Numéro de séquence
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.sequence
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.sequence
* group[=].element[=].target.equivalence = #equivalent
...
// Dose administrée par prise
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.doseAndRate.dose[x]
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.doseAndRate.dose[x]
* group[=].element[=].target.equivalence = #equivalent
// Rythme d'administration
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.doseAndRate.rate[x]
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.doseAndRate.rate[x]
* group[=].element[=].target.equivalence = #equivalent
// Fréquence de prise
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.frequency
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat
...
// Nombre de prises par période
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.frequency.numberOfTimes
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat.frequency
* group[=].element[=].target.equivalence = #equivalent
// Période associée à la fréquence
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.frequency.period
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat.period
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "L'unité (periodUnit) est portée par le code de la Quantity source."
// Jour de la semaine
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.frequency.dayOfWeek
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat.dayOfWeek
* group[=].element[=].target.equivalence = #equivalent
// Heure de prise
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.frequency.timeOfDay
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat.timeOfDay
* group[=].element[=].target.equivalence = #equivalent
// Instruction additionnelle liée à la fréquence
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.frequency.additionalInstructions
...
// Date précise de prise
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.dateOfAdministration
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.event
* group[=].element[=].target.equivalence = #equivalent
// Condition de prise
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.conditionOfAdministration
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.asNeededCodeableConcept
* group[=].element[=].target.equivalence = #equivalent
// Date / période / durée de la séquence de traitement
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.date[x]
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat.bounds[x]
* group[=].element[=].target.equivalence = #equivalent
// Durée d'administration
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.duration
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat
...
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat.duration
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat.durationUnit
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat.durationMax
* group[=].element[=].target.equivalence = #equivalent
// Événement de prise (ex : avant repas)
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.eventTime
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat
...
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat.when
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.timing.repeat.offset
* group[=].element[=].target.equivalence = #equivalent
// Événement de fin de séquence
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.eventEndSequence
* group[=].element[=].target.equivalence = #unmatched
// Région anatomique d'administration
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.bodySite
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.site
* group[=].element[=].target.equivalence = #equivalent
// Voie d'administration
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.routeOfAdministration
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.route
* group[=].element[=].target.equivalence = #equivalent
// Dose maximale par période
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.maxDosePerPeriod.quantity
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.maxDosePerPeriod.numerator
* group[=].element[=].target.equivalence = #equivalent
// Durée associée à la dose maximale par période
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.maxDosePerPeriod.duration
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.maxDosePerPeriod.denominator
* group[=].element[=].target.equivalence = #equivalent
// Dose maximale par administration
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.maxDosePerAdministration
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.maxDosePerAdministration
* group[=].element[=].target.equivalence = #equivalent
// Dose maximale sur la durée de vie
* group[=].element[+].code = #FRLMMedicationDispense.dosageInstructions.dosageDetails.maxLifetimeDose
* group[=].element[=].target.code = #FRMedicationDispenseDocument.dosageInstruction.maxDosePerLifetime
* group[=].element[=].target.equivalence = #equivalent
// Notes du dispensateur
* group[=].element[+].code = #FRLMMedicationDispense.note
* group[=].element[=].target.code = #FRMedicationDispenseDocument.note
* group[=].element[=].target.equivalence = #equivalent
