...
* group[=].element[=].target.code = #FRCDADocumentAttache.component:frObservationMedia.observationMedia.value.mediaType
* group[=].element[=].target.equivalence = #equivalent
// Langue du document attaché
* group[=].element[+].code = #FRLMAttachment.language
* group[=].element[=].target.code = #FRCDADocumentAttache.component:frObservationMedia.observationMedia.languageCode
* group[=].element[=].target.equivalence = #equivalent
// Document attaché encodé en Base64
* group[=].element[+].code = #FRLMAttachment.data
* group[=].element[=].target.code = #FRCDADocumentAttache.component:frObservationMedia.observationMedia.value
* group[=].element[=].target.equivalence = #equivalent
// URL de la ressource
* group[=].element[+].code = #FRLMAttachment.url
* group[=].element[=].target.code = #FRCDADocumentAttache.component:frObservationMedia.observationMedia.value.reference
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.equivalence = #FRCDADocumentAttache.component:frTypeDocumentAttache.observation.text.reference
...
// Type MIME
* group[=].element[+].code = #FRLMAttachment.contentType
* group[=].element[=].target.code = #FRDocumentReferenceDocument.content.attachment.contentType
* group[=].element[=].target.equivalence = #equivalent
// Langue du document attaché
* group[=].element[+].code = #FRLMAttachment.language
* group[=].element[=].target.code = #FRDocumentReferenceDocument.content.attachment.language
* group[=].element[=].target.equivalence = #equivalent
// Document attaché encodé en Base64
* group[=].element[+].code = #FRLMAttachment.data
...
// Référence externe
* group[=].element[+].code = #FRLMAttachment.url
* group[=].element[=].target.code = #FRDocumentReferenceDocument.content.attachment.url
* group[=].element[=].target.equivalence = #equivalent
// Taille du document attaché
* group[=].element[+].code = #FRLMAttachment.size
* group[=].element[=].target.code = #FRDocumentReferenceDocument.content.attachment.size
* group[=].element[=].target.equivalence = #equivalent
// Titre du document attaché
* group[=].element[+].code = #FRLMAttachment.title
* group[=].element[=].target.code = #FRDocumentReferenceDocument.content.attachment.title
* group[=].element[=].target.equivalence = #equivalent
