...
* group[+].source = "https://interop.esante.gouv.fr/ig/document-core/StructureDefinition/FRLMResultatsExamensBiologieMedicale"
...
* group[=].element[=].target.display = "FRCDAResultatExamensDeBiologie"
...
* group[=].element[=].target.code = #Act.subject
* group[=].element[=].target.equivalence = #equivalent
...
* group[+].source = "https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-resultats-examens-de-biologie-medicale"
...
* group[=].element[=].target.equivalence = #equivalent
// prelevement
* group[=].element[+].code = #Act.entryRelationship:frPrelevement  
* group[=].element[=].target.code = #Observation.specimen
* group[=].element[=].target.equivalence = #equivalent
// commentaire
* group[=].element[+].code = #Act.entryRelationship:frCommentaireER
* group[=].element[=].target.code = #Observation.note
* group[=].element[=].target.equivalence = #equivalent
// batterie examens de biologie médicale
* group[=].element[+].code = #Act.entryRelationship:frBatterieExamensDeBiologieMedicale
* group[=].element[=].target.code = #Observation.hasMember:FRObservationLaboratoryReportResultsDocument
* group[=].element[=].target.equivalence = #equivalent
// isolat microbiologique
* group[=].element[+].code = #Act.entryRelationship:frIsolatMicrobiologique
* group[=].element[=].target.code = #Observation.hasMember:FRObservationLaboratoryReportResultsDocument
* group[=].element[=].target.equivalence = #equivalent
// resultat element clinique pertinent
* group[=].element[+].code = #Act.entryRelationship:frResultatExamensDeBiologieElementCliniquePertinent
* group[=].element[=].target.code = #Observation.hasMember:FRObservationLaboratoryReportResultsDocument
* group[=].element[=].target.equivalence = #equivalent
// image illustrative
* group[=].element[+].code = #Act.entryRelationship:frImageIllustrative
