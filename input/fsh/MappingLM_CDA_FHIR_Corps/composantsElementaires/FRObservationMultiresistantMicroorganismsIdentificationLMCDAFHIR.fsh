...
* group[=].element[=].target.display = "FRCDAIdentificationMicroOrganismesMultiresistants"
...
* group[=].element[+].code = #FRLMMultidrugResistantMicroorganismIdentification
* group[=].element[=].target.code = #Observation
* group[=].element[=].target.display = "FRObservationMultidrugResistantMicroorganismIdentification"
* group[=].element[=].target.equivalence = #equivalent
