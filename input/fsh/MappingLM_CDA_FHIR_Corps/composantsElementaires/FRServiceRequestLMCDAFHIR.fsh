...
* group[=].element[=].target.code = #FRCDADemandeDExamenOuDeSuivi.entryRelationship.encounter
* group[=].element[=].target.equivalence = #equivalent
...
// Quantité demandée
* group[=].element[+].code = #FRLMServiceRequest.quantity
* group[=].element[=].target.code = #FRServiceRequestDocument.quantity
* group[=].element[=].target.equivalence = #equivalent
// Localisation anatomique
* group[=].element[+].code = #FRLMServiceRequest.bodySite
...
// Motif de la demande
* group[=].element[+].code = #FRLMServiceRequest.reason[x]
* group[=].element[=].target.code = #FRServiceRequestDocument.reasonCode
* group[=].element[=].target.equivalence = #equivalent
// Priorité de la demande
* group[=].element[+].code = #FRLMServiceRequest.priority
* group[=].element[=].target.code = #FRServiceRequestDocument.priority
* group[=].element[=].target.equivalence = #equivalent
// Informations pertinentes pour l'interprétation
* group[=].element[+].code = #FRLMServiceRequest.supportingInformation[x]
* group[=].element[=].target.code = #FRServiceRequestDocument.supportingInfo
* group[=].element[=].target.equivalence = #equivalent
// Prélèvement
* group[=].element[+].code = #FRLMServiceRequest.specimen
* group[=].element[=].target.code = #FRServiceRequestDocument.specimen
* group[=].element[=].target.equivalence = #equivalent
// Consultation à l'origine
* group[=].element[+].code = #FRLMServiceRequest.encounter
* group[=].element[=].target.code = #FRServiceRequestDocument.encounter
* group[=].element[=].target.equivalence = #equivalent
// Date ou période prévisionnelle
* group[=].element[+].code = #FRLMServiceRequest.occurrence[x]
