...
// Code du medicament
* group[=].element[+].code = #FRLMMedicationAdministration.medication.identifyingCode[x]
* group[=].element[=].target.code = #MedicationAdministration.medication:FRMedicationDocument.code
* group[=].element[=].target.equivalence = #equivalent
// Nom du medicament
* group[=].element[+].code = #FRLMMedicationAdministration.medication.productName
* group[=].element[=].target.code = #MedicationAdministration.medication:FRMedicationDocument.extension:productName
* group[=].element[=].target.equivalence = #equivalent
// Numero de lot
* group[=].element[+].code = #FRLMMedicationAdministration.medication.batch.lotNumber
* group[=].element[=].target.code = #MedicationAdministration.medication:FRMedicationDocument.batch.lotNumber
* group[=].element[=].target.equivalence = #equivalent
// Posologie
