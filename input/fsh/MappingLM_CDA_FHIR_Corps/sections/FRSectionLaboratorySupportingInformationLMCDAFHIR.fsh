...
Usage: #definition
Title: "Mapping FRLMLaboratorySupportingInformation → FRCDASectionInformationsCliniques / FRLMLaboratorySupportingInformation → FRServiceRequestDocument.supportingInformation"
...
* group[+].source = "https://interop.esante.gouv.fr/ig/document-core/StructureDefinition/FRLMLaboratorySupportingInformation"
* group[=].target = "https://interop.esante.gouv.fr/ig/cda/document-core/StructureDefinition/fr-cda-section-informations-cliniques"
// élément racine
* group[=].element[+].code = #FRLMLaboratorySupportingInformation
* group[=].element[=].target.code = #Section
* group[=].element[=].target.display = "FRCDASectionInformationsCliniques"
* group[=].element[=].target.equivalence = #equivalent
// code de la section
* group[=].element[+].code = #FRLMLaboratorySupportingInformation.codeSection
* group[=].element[=].target.code = #Section.code
* group[=].element[=].target.equivalence = #equivalent
// titre de la section
* group[=].element[+].code = #FRLMLaboratorySupportingInformation.titleSection
* group[=].element[=].target.code = #Section.title
* group[=].element[=].target.equivalence = #equivalent
// bloc narratif
* group[=].element[+].code = #FRLMLaboratorySupportingInformation.description
* group[=].element[=].target.code = #Section.text
* group[=].element[=].target.equivalence = #equivalent
// résultats cliniques et autres observations
* group[=].element[+].code = #FRLMLaboratorySupportingInformation.entry.observation
* group[=].element[=].target.code = #Section.entry.observation
* group[=].element[=].target.display = "FRCDASimpleObservation"
* group[=].element[=].target.equivalence = #equivalent
// problèmes
* group[=].element[+].code = #FRLMLaboratorySupportingInformation.entry.condition
* group[=].element[=].target.code = #Section.entry.observation
* group[=].element[=].target.display = "FRCDAProbleme"
* group[=].element[=].target.equivalence = #equivalent
// produits de santé administrés avant l'examen
* group[=].element[+].code = #FRLMLaboratorySupportingInformation.entry.medicationAdministration
* group[=].element[=].target.code = #Section.entry.substanceAdministration
* group[=].element[=].target.display = "FRCDATraitement"
* group[=].element[=].target.equivalence = #equivalent
// sexe clinique
* group[=].element[+].code = #FRLMLaboratorySupportingInformation.entry.sexForClinicalUse
* group[=].element[=].target.equivalence = #unmatched
* group[=].element[=].target.comment = "Aucune cible CDA explicite identifiée dans FRCDASectionInformationsCliniques pour FRLMLaboratorySupportingInformation.entry.sexForClinicalUse ; cette donnée relève du contexte patient."
// historique vaccinal
* group[=].element[+].code = #FRLMLaboratorySupportingInformation.entry.vaccination
* group[=].element[=].target.code = #Section.entry.substanceAdministration
* group[=].element[=].target.display = "FRCDAVaccination"
* group[=].element[=].target.equivalence = #equivalent
// autres informations cliniques pertinentes
* group[=].element[+].code = #FRLMLaboratorySupportingInformation.entry.otherSupportingInformation
* group[=].element[=].target.equivalence = #unmatched
* group[=].element[=].target.comment = "Aucune cible CDA explicite identifiée dans FRCDASectionInformationsCliniques pour FRLMLaboratorySupportingInformation.entry.otherSupportingInformation ; la ressource référencée n'est pas typée."
...
* group[=].element[+].code = #FRLMLaboratorySupportingInformation.entry.sexForClinicalUse
* group[=].element[=].target.equivalence = #unmatched
* group[=].element[=].target.comment = "Aucune cible FHIR explicite identifiée pour FRLMLaboratorySupportingInformation.entry.sexForClinicalUse ; cette donnée existe dans le patient."
// historique vaccinal
* group[=].element[+].code = #FRLMLaboratorySupportingInformation.entry.vaccination
* group[=].element[=].target.code = #ServiceRequest.supportingInformation
