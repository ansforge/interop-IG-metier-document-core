...
* group[=].element[=].target[+].code = #Section.entry:FRCDATraitementPrescrit
* group[=].element[=].target[=].equivalence = #equivalent
...
// élément racine
* group[=].element[+].code = #FRLMMedicationPrescription
* group[=].element[=].target[+].code = #Composition.section:sectionMedicationRequest
* group[=].element[=].target[=].display = "FRCompositionDocument.section:sectionMedicationRequest"
* group[=].element[=].target[=].equivalence = #equivalent   
// auteur de la prescription
* group[=].element[+].code = #FRLMMedicationPrescription.author[x]
* group[=].element[=].target[+].code = #Composition.section:sectionMedicationRequest.author
* group[=].element[=].target[=].equivalence = #equivalent
// code de la section
* group[=].element[+].code = #FRLMMedicationPrescription.codeSection
* group[=].element[=].target[+].code = #Composition.section:sectionMedicationRequest.code
* group[=].element[=].target[=].equivalence = #equivalent
// titre de la section
* group[=].element[+].code = #FRLMMedicationPrescription.titleSection
* group[=].element[=].target[+].code = #Composition.section:sectionMedicationRequest.title
* group[=].element[=].target[=].equivalence = #equivalent
// bloc narratif de la section
* group[=].element[+].code = #FRLMMedicationPrescription.description
* group[=].element[=].target[+].code = #Composition.section:sectionMedicationRequest.text
* group[=].element[=].target[=].equivalence = #equivalent
// Entrée Traitement prescrit
* group[=].element[+].code = #FRLMMedicationPrescription.entry.prescriptionItem:FRLMPrescriptionItem
* group[=].element[=].target[+].code = #Composition.section:sectionMedicationRequest.entry:FRMedicationRequestDocument
* group[=].element[=].target[=].equivalence = #equivalent
