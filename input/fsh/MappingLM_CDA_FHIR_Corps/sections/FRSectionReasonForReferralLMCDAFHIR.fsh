...
// élément racine
* group[=].element[+].code = #FRLMReasonForReferral
* group[=].element[=].target[+].code = #FRCompositionDocument.section:sectionReasonForReferral
* group[=].element[=].target[=].equivalence = #equivalent
// code de la section
* group[=].element[+].code = #FRLMReasonForReferral.codeSection
* group[=].element[=].target[+].code = #FRCompositionDocument.section:sectionReasonForReferral.code
* group[=].element[=].target[=].equivalence = #equivalent
// titre de la section
* group[=].element[+].code = #FRLMReasonForReferral.titleSection
* group[=].element[=].target[+].code = #FRCompositionDocument.section:sectionReasonForReferral.title
* group[=].element[=].target[=].equivalence = #equivalent
// bloc narratif de la section
* group[=].element[+].code = #FRLMReasonForReferral.description
* group[=].element[=].target[+].code = #FRCompositionDocument.section:sectionReasonForReferral.text
* group[=].element[=].target[=].equivalence = #equivalent
// Entrée Simple observation
* group[=].element[+].code = #FRLMReasonForReferral.entry.observation
* group[=].element[=].target[+].code = #FRCompositionDocument.section:sectionReasonForReferral.entry:Observation
* group[=].element[=].target[=].equivalence = #equivalent
// Entrée Problème
* group[=].element[+].code = #FRLMReasonForReferral.entry.problemes
* group[=].element[=].target[+].code = #FRCompositionDocument.section:sectionReasonForReferral.entry:FRConditionDocument
* group[=].element[=].target[=].equivalence = #equivalent
