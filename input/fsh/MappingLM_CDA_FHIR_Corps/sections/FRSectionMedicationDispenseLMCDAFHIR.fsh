...
// Élément racine
* group[=].element[+].code = #FRLMMedicationDispensations
* group[=].element[=].target.code = #FRCompositionDocument.section:sectionMedicationDispense
* group[=].element[=].target.equivalence = #equivalent
// code de la section
* group[=].element[+].code = #FRLMMedicationDispensations.codeSection
* group[=].element[=].target.code = #FRCompositionDocument.section:sectionMedicationDispense.code
* group[=].element[=].target.equivalence = #equivalent
// Description narrative de la section
* group[=].element[+].code = #FRLMMedicationDispensations.description
* group[=].element[=].target.code = #FRCompositionDocument.section:sectionMedicationDispense.text
* group[=].element[=].target.equivalence = #equivalent
// Titre de la section
* group[=].element[+].code = #FRLMMedicationDispensations.titleSection
* group[=].element[=].target.code = #FRCompositionDocument.section:sectionMedicationDispense.title
* group[=].element[=].target.equivalence = #equivalent
// entrées de la section
* group[=].element[+].code = #FRLMMedicationDispensations.entry.medicationDispense:FRLMMedicationDispense
* group[=].element[=].target.code = #FRCompositionDocument.section:sectionMedicationDispense.entry:FRMedicationDispenseDocument
* group[=].element[=].target.equivalence = #equivalent
