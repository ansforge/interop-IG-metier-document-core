...
Usage: #definition
Title: "Mapping FRLMAllergiesAndIntolerances → FRCDAAllergiesEtHypersensibilites / FRLMAllergiesAndIntolerances → FRCompositionDocument.section:allergiesAndIntolerances"
Description: "Mapping des éléments du modèle métier FRLMAllergiesEtHypersensibilites vers la section CDA FRCDAAllergiesEtHypersensibilites, puis vers le profil FHIR FRCompositionDocument.section:allergiesAndIntolerances."
...
// Élément racine
* group[=].element[+].code = #FRLMAllergiesAndIntolerances
* group[=].element[=].target.code = #FRCompositionDocument.section:allergiesAndIntolerances
* group[=].element[=].target.equivalence = #equivalent
// Code de la section
* group[=].element[+].code = #FRLMAllergiesAndIntolerances.codeSection
* group[=].element[=].target.code = #FRCompositionDocument.section:allergiesAndIntolerances.code
* group[=].element[=].target.equivalence = #equivalent
// Titre de la section
* group[=].element[+].code = #FRLMAllergiesAndIntolerances.titleSection
* group[=].element[=].target.code = #FRCompositionDocument.section:allergiesAndIntolerances.title
* group[=].element[=].target.equivalence = #equivalent
// Description narrative de la section
* group[=].element[+].code = #FRLMAllergiesAndIntolerances.description
* group[=].element[=].target.code = #FRCompositionDocument.section:allergiesAndIntolerances.text
* group[=].element[=].target.equivalence = #equivalent
// Entrée : Allergie ou intolérance
* group[=].element[+].code = #FRLMAllergiesAndIntolerances.entry.allergieIntolerance:FRLMAllergyIntolerance
* group[=].element[=].target.code = #FRCompositionDocument.section:allergiesAndIntolerances.entry:FRAllergyIntoleranceDocument
* group[=].element[=].target.equivalence = #equivalent