...
// code de la section
* group[=].element[+].code = #FRLMCarePlans.codeSection
* group[=].element[=].target[+].code = #Composition.section:sectionPlanOfCare.code
* group[=].element[=].target[=].equivalence = #equivalent
// titre de la section
* group[=].element[+].code = #FRLMCarePlans.titleSection
* group[=].element[=].target[+].code = #Composition.section:sectionPlanOfCare.title
* group[=].element[=].target[=].equivalence = #equivalent
// bloc narratif de la section
* group[=].element[+].code = #FRLMCarePlans.description
...
* group[=].element[=].target[=].equivalence = #equivalent
// Entrée Plan de soins
* group[=].element[+].code = #Section.entry:carePlans:FRLMCarePlan
* group[=].element[=].target[+].code = #Composition.section:sectionPlanOfCare.entry:FRCarePlanDocument
* group[=].element[=].target[=].equivalence = #equivalent