...
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Première occurrence : identifiant unique du document."
// Identifiant du lot de versions
* group[=].element[+].code = #FRLMHeaderDocument.identifier
* group[=].element[=].target.code = #ClinicalDocument.setId
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Occurrence(s) suivante(s) : identifiant du lot de versions du document."
