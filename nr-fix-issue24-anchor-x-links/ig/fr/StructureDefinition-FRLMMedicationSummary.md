...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fr.document-core|current/StructureDefinition/FRLMMedicationSummary)
...
Autres représentations du profil : [CSV](../StructureDefinition-FRLMMedicationSummary.csv), [Excel](../StructureDefinition-FRLMMedicationSummary.xlsx) 
