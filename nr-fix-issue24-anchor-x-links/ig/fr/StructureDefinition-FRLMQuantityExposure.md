...
* Utilise ce/t/te Modèle logique: [Logical model - FR LM Exposure Information](StructureDefinition-FRLMExposureInformation.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fr.document-core|current/StructureDefinition/FRLMQuantityExposure)
...
Autres représentations du profil : [CSV](../StructureDefinition-FRLMQuantityExposure.csv), [Excel](../StructureDefinition-FRLMQuantityExposure.xlsx) 
