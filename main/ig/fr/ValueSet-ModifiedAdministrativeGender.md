# ModifiedAdministrativeGender - FR Document Core (Modèle métier) v0.1.0
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document-core/ValueSet/ModifiedAdministrativeGender",
  "version" : "0.1.0",
