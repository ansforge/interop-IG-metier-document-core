# Mapping FRLMExpositionRadiations → FRCDADICOMExpositionAuxRadiations → FRCompositionDocument.section:exposureRadiation - FR Document Core (Modèle métier) v0.1.0
